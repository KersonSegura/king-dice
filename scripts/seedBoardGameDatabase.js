...
<li>Cartas de desarrollo de puntos de victoria</li>
  ...
  await prisma.gameDescription.upsert({
    ...
    create: {
      ...
      fullDescription: 'Gatos Explosivos es un juego de cartas altamente estratégico y alimentado por gatitos de la Ruleta Rusa. Los jugadores se turnan para robar cartas hasta que alguien robe un gato explosivo y pierda el juego.',
    },
  });
