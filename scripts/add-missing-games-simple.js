...
// Just a few games to reach 50
const missingGames = [
  { bggId: 12493, name: "Android: Netrunner", category: 'ranked' },
  { bggId: 120677, name: "Terra Mystica", category: 'ranked' },
  { bggId: 146021, name: "Fields of Arle", category: 'ranked' },
  { bggId: 155069, name: "Orléans", category: 'ranked' },
  { bggId: 12493, name: "Android: Netrunner", category: 'hot' },
  { bggId: 120677, name: "Terra Mystica", category: 'hot' },
  { bggId: 146021, name: "Fields of Arle", category: 'hot' },
  { bggId: 155069, name: "Orléans", category: 'hot' },
  { bggId: 12493, name: "Android: Netrunner", category: 'hot' },
  { bggId: 120677, name: "Terra Mystica", category: 'hot' }
];
...
async function addMissingGames() {
  ...
  for (let i = 0; i < missingGames.length; i++) {
    ...
    console.log(`\n🔄 [${i + 1}/${missingGames.length}] Adding ${game.category} game: ${game.name} (BGG ID: ${game.bggId})`);
