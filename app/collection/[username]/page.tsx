...
export default function CollectionPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      {/* Games List Modal */}
      {showGamesListModal && (() => {
        // Ensure t is available before rendering modal
        if (typeof t !== 'function') {
          console.error('ERROR: t is not a function when rendering modal!', { t, type: typeof t });
          return null;
        }
        return (
            ...
            <div className="p-6 overflow-y-auto max-h-[60vh]">
              {tempGamesList && tempGamesList.length > 0 ? (
                ...
                <div className="text-center py-12 text-gray-500">
                  ...
                  <p className="text-lg">{typeof t === 'function' ? t('noGamesInCollection') : 'No games in collection'}</p>
                </div>
              )}
            </div>
