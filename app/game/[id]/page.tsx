            ...
            <div className="p-8 w-full" style={{ minWidth: isDesktop ? '1000px' : '0', maxWidth: '100%', boxSizing: 'border-box' }}>
              ...
              {activeTab === 'shop' && (game?.shopItems?.length || game?.shopUrl || game?.amazonUrl) && (
                <div className="w-full -mx-8 sm:mx-0">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center px-8 sm:px-0">
                    <img 
                      src="/ShopIcon.svg" 
                      alt="Shop" 
                  ...
                  <div className="prose max-w-none w-full">
                    <div className="text-gray-700 leading-relaxed w-full">
                      ...
                      <div className="flex justify-center md:block">
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4 mb-8 px-4 sm:px-0 w-full max-w-full">
