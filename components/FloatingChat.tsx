  ...
  return (
    <>
      ...
      {!isChatOpen && showAutoTooltip && (
        <div className="fixed bottom-4 right-20 sm:bottom-20 sm:right-4 z-50 px-3 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm rounded-lg shadow-lg w-80 tooltip-bounce">
