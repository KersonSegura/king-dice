      ...
      <div className="fixed bottom-4 right-4 z-40 sm:bottom-4 sm:right-4" style={{ position: 'fixed', bottom: '1rem', right: '1rem' }}>
        {!isChatOpen ? (
          <div className="relative">
            ...
            {showAutoTooltip && (
              <div className="absolute right-full -top-4 mr-2 sm:bottom-full sm:right-0 sm:top-auto sm:mr-0 sm:mb-2 px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm rounded-lg shadow-lg w-80 tooltip-bounce">
