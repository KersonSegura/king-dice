...
export const ASSET_LEVEL_REQUIREMENTS: Record<string, Record<string, AssetLevelRequirement>> = {
  ...
  patterns: {
    '123': { level: 1, levelName: 'Commoner', description: '1 2 3 - unlocks at level 1' },
    '214': { level: 1, levelName: 'Commoner', description: '2 1 4 - unlocks at level 1' },
    '365': { level: 1, levelName: 'Commoner', description: '3 6 5 - unlocks at level 1' },
    '456': { level: 1, levelName: 'Commoner', description: '4 5 6 - unlocks at level 1' },
    '541': { level: 1, levelName: 'Commoner', description: '5 4 1 - unlocks at level 1' },
    '632': { level: 1, levelName: 'Commoner', description: '6 3 2 - unlocks at level 1' },
