/**
 * ProfileIconOn.svg and LockIcon.svg bundled inline (from public/).
...
export function ProfileIconOnSvg({ size = 20, color }: Props) {
  const xml = color ? applyColor(PROFILE_ICON_XML, color) : PROFILE_ICON_XML;
